        ...
        <div class="relative px-4 pt-6 sm:px-6 lg:px-8">
          <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
            ...
            <div class="hidden md:ml-10 md:block md:space-x-8 md:pr-4 text-lg">
              <a href="#" class="font-medium font-weight: 600; text-gray-900 hover:text-indigo-900">Skills</a>

              <a href="#" class="font-semibold text-gray-700 hover:text-indigo-900">Skills I am learning</a>

              <a href="#" class="font-medium text-gray-700 hover:text-indigo-900">Resume</a>

              <a href="#" class="font-medium text-gray-700 hover:text-indigo-900">LinkedIn</a>

              <a href="#" class="font-medium text-gray-700 hover:text-indigo-900">GitHub</a>
            </div>
          </nav>
        </div>
      ...
      <main class="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-14 lg:px-8 xl:mt-14">
        <div class="sm:text-center lg:text-left">
          ...
          <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
            ...
            <img class="h-35 w-55 " src={require('../../Assets/Images/FullStackWebDevelopment.png')} alt=""></img>
          </div>
        </div>
      </main>
    </div>
