...
const Projects = () => {
  return (
    ...
    >
      ...
      <main className="w-full flex flex-wrap mt-10 max-w-10xl  sm:mt-12 sm:px-6 md:mt-16 lg:mt-14 lg:px-8 xl:mt-14">
        {/* <div className="w-full flex flex-wrap"> */}
          <div className=" w-full block flex flex-wrap card">
            <div className="block-1 w-full pr-5 md:p-2">
              <img
          ...
          <div className="block flex flex-wrap card">
