...
<footer className=" footer text-center text-white" >
  <div className="container pt-9">
    <div className="flex justify-center mb-9">
      ...
      <a href="https://www.instagram.com/vinyldude8896/" target="_blank" className="mr-9 text-gray-800">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a href="https://www.linkedin.com/in/kevinreidkr" target="_blank" className="mr-9 text-gray-800">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a href="https://github.com/Vinyldude8896" target="_blank" className="text-gray-800">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
